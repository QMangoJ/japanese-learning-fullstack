...
const kanjiMeaning: Record<string, string> = {
	...
	便: "convenience; service", 利: "advantage; benefit", 使: "use", 銀: "silver", 白: "white", 黒: "black", 紙: "paper",
	...
	住: "live; reside", 所: "place", 様: "formal title; manner", 主: "main; owner", 番: "number; turn", 地: "ground; place", 号: "number; issue", 京: "capital",
	国: "country", 都: "metropolis; capital", 道: "road; way", 府: "urban prefecture", 県: "prefecture", 市: "city; market", 区: "ward; district", 村: "village",
	毎: "every", 週: "week", 映: "reflect; project", 画: "picture; stroke", 館: "public building; hall", 公: "public", 園: "garden; park",
...
const wordMeaning: Record<string, string> = {
	...
	親: "parent", 親しい: "close; intimate", 親切: "kind; helpful", 両親: "parents", 切って: "cut", 売りました: "sold", 売れました: "sold; was sold", 売店: "kiosk; concession stand",
	...
	便り: "news; letter", 便利: "convenient", 郵便局: "post office", 便: "access; service; convenience", 利用: "use; utilization", 使い方: "how to use", 大使: "ambassador", 使用: "use",
	銀行: "bank", 使います: "use", 銀メダル: "silver medal", 白黒: "black and white", 白い: "white", 白衣: "white coat", 真っ黒: "pitch-black", 黒板: "blackboard",
	紙: "paper", 用紙: "form; sheet of paper", 新聞紙: "newspaper", 折り紙: "origami",
	朝: "morning", 朝食: "breakfast", 朝日: "morning sun", 朝晩: "morning and evening", "晩ごはん": "dinner", 昼休み: "lunch break", 昼食: "lunch",
	夜: "night", 夜道: "road at night", 夜食: "late-night meal", 前: "front; before", 名前: "name", 前後: "before and after; around", 後ろ: "behind; back", 後: "after; later",
	午前: "a.m.; morning", 午後: "p.m.; afternoon", 正午: "noon", 早くて: "early", 早く: "early; quickly", 早朝: "early morning",
	荷物: "luggage; package", 手荷物: "hand luggage", 送って: "send", 送りました: "sent", 送別会: "farewell party", "お宅": "your home", 住宅: "house; housing", 宅配: "home delivery",
	急いで: "hurry", 急に: "suddenly", 速い: "fast", 時速: "speed per hour", 遅れて: "be late", 遅刻: "lateness; be late", 重ねて: "stack; place on top", 重い: "heavy", 重要: "important", 軽くて: "light", 軽く: "lightly",
	住んで: "live; reside", 住宅街: "residential area", 所: "place", 住所: "address", "お客様": "customer; guest (polite)", 様: "formal title; manner", 様子: "state; appearance", 持ち主: "owner", "ご主人": "husband; master",
	一番: "number one; most", 交番: "police box", 掃除当番: "cleaning duty", 地下: "underground; basement", 地味: "plain; subdued", 電話番号: "telephone number", "301号室": "Room 301", "11月号": "November issue", 東京: "Tokyo", 京浜: "Tokyo–Yokohama area",
	国: "country", 国語: "national language; Japanese", 国籍: "nationality", 東京都: "Tokyo Metropolis", 首都: "capital city", 都会: "city; urban area", 道: "road; way", 北海道: "Hokkaido", 大阪府: "Osaka Prefecture", 府: "urban prefecture", 県: "prefecture", 山口県: "Yamaguchi Prefecture",
	市役所: "city hall", 市長: "mayor", 朝市: "morning market", 区: "ward; district", 区内: "within the ward", 村: "village", 市町村: "municipalities",
	毎日: "every day", 毎年: "every year", 毎週: "every week", "1週間": "one week", 週末: "weekend", 映って: "appear; be shown", 映します: "project; show; reflect", 映画: "movie", 画家: "painter", 計画: "plan", 映画館: "movie theater", 大使館: "embassy", 洋館: "Western-style building",
	"公に": "publicly", 公立: "public; state-run", 公私: "public and private", 主人公: "main character", 公園: "park",
	夫: "husband", "ご夫妻": "married couple (polite)", 夫婦: "married couple", 妻: "wife", 愛妻家: "devoted husband", 特に: "especially", 特別: "special", 思って: "think", 思い出: "memory", 意思: "intention; will",
	料金: "fee; charge", 食料: "food supplies", 給料: "salary", 料理: "cooking; cuisine", 理系: "science field", 有名: "famous", 有力: "influential; likely", 有料: "paid; fee-charging",
	...
	工学部: "faculty of engineering", スキー場: "ski resort", 人工: "artificial; man-made", 工場: "factory", 場: "place; occasion", 本場: "authentic place; home of something", 始まります: "begin", 年始: "beginning of the year", 始業式: "opening ceremony", 終わって: "finish", 終電: "last train",
};
