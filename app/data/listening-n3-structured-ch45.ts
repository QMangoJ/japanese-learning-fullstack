		...
		pages: [
			{
				...
				blocks: [
					...
					{ kind: "list", items: ["AはBより〜だ。田中さんの家は私の家より大きい。", "AよりBのほうが〜だ。私、コーヒーより紅茶のほうが好きだ。", "Aが最も〜・一番〜だ。私にとってはカタカナが最も難しい。", "AはBほど〜ではない。日本では、豚肉は牛肉ほど高くない。", "Aも〜だがBほどじゃない。ニューヨークも車が多いが東京ほどじゃない。", "AはBに比べて〜だ。今日は昨日に比べて暑い。"] },
				],
			},
			{
				page: 62,
