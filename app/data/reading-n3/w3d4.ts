...
export const w3d4: ReadingDay = {
	...
	renshu: {
		...
		footnotes: [
			{ marker: "※1", term: "転居通知", jp: "a notification of a change of address", cn: "搬家通知" },
			{ marker: "※2", term: "新築", jp: "a new house", cn: "新建（的房子）" },
			{ marker: "※3", term: "大したことはない", jp: "nothing special", cn: "没什么了不起" },
		],
		choices: [
			{ jp: "この{夫婦|ふうふ}の{庭|にわ}に{桜|さくら}の{木|き}がある。", cn: "这对夫妻的院子里有樱花树。" },
			{ jp: "{今|いま}、この{夫婦|ふうふ}は{公園|こうえん}を{散歩|さんぽ}している。", cn: "现在这对夫妻正在公园里散步。" },
			{ jp: "この{夫婦|ふうふ}は、{最近|さいきん}この{家|いえ}に{引|ひ}っ{越|こ}した。", cn: "这对夫妻最近搬到了这个家。" },
			{ jp: "この{夫婦|ふうふ}は{引|ひ}っ{越|こ}しを{知|し}らせるはがきを{出|だ}す{予定|よてい}である。", cn: "这对夫妻打算寄明信片通知搬家的事。" },
			{ jp: "{桜|さくら}は2{週間前|しゅうかんまえ}に{咲|さ}き{始|はじ}めた。", cn: "樱花两周前开始开了。" },
		],
		answers: [3, 4],
		hint: {
	...
	mondai: {
		...
		blocks: [
			...
			{ type: "line", jp: "〒155-XXXX　{三鷹市|みたかし}○{町|ちょう}3-32-20", cn: "邮编 155-XXXX　三鹰市○町 3-32-20" },
			{ type: "line", jp: "TEL&FAX：042-333-XXXX", cn: "电话&传真：042-333-XXXX" },
			{ type: "line", jp: "E-mail：masaotani@XXXX.ne.jp", cn: "电子邮箱：masaotani@XXXX.ne.jp" },
			{ type: "line", jp: "{谷|たに}　{正雄|まさお}", cn: "谷　正雄", align: "right" },
		],
		footnotes: [
			{ marker: "※1", term: "つきましては", jp: "therefore", cn: "因此、于是" },
			{ marker: "※2", term: "これを機会に", jp: "take this opportunity", cn: "借此机会" },
			{
				marker: "※3",
				term: "同期生",
		...
		questions: [
			{
				...
				cn: "谷先生为什么寄出这张明信片？",
				choices: [
					{ jp: "{新|あたら}しい{家|いえ}が{気|き}に{入|い}っていることを{知|し}らせたいから。", cn: "因为想告诉大家自己很喜欢新家。" },
					{ jp: "もうすぐ{家|いえ}が{完成|かんせい}するということを{知|し}らせたいから。", cn: "因为想通知大家房子快要完工了。" },
					{ jp: "{野川公園|のがわこうえん}を{一緒|いっしょ}に{散歩|さんぽ}したいから。", cn: "因为想一起在野川公园散步。" },
					{ jp: "{新|あたら}しい{家|いえ}に{招待|しょうたい}したいから。", cn: "因为想邀请大家到新家做客。" },
				],
				answer: 4,
				explanation:
			...
			},
			{
				...
				cn: "「おいでになる（前来）」的人是谁？",
				choices: [
					{ jp: "{谷|たに}さんの{先生|せんせい}", cn: "谷先生的老师" },
					{ jp: "{谷|たに}さんの{上司|じょうし}", cn: "谷先生的上司" },
					{ jp: "{谷|たに}さんの{友人|ゆうじん}", cn: "谷先生的朋友" },
					{ jp: "{谷|たに}さんの{親|しん}せき", cn: "谷先生的亲戚" },
				],
				answer: 3,
				explanation:
	...
	vocab: [
		{ jp: "このところ", cn: "近来、最近", pos: "副詞" },
		{ jp: "このたび", cn: "此次、这回", pos: "名詞" },
		{ jp: "建築中", kana: "けんちくちゅう", cn: "施工中、建造中", pos: "名詞" },
		{ jp: "完成する", kana: "かんせいする", cn: "完工、完成", pos: "動詞" },
		{ jp: "下記", kana: "かき", cn: "下述、下列", pos: "名詞" },
		{ jp: "引っ越す", kana: "ひっこす", cn: "搬家", pos: "動詞" },
		{ jp: "平凡", kana: "へいぼん", cn: "平凡、普通", pos: "な形" },
		{ jp: "眺め", kana: "ながめ", cn: "景色、眺望", pos: "名詞" },
		{ jp: "つきましては", cn: "因此（书面语）", pos: "接続詞" },
		{ jp: "わが家", kana: "わがや", cn: "寒舍、我家", pos: "名詞" },
		{ jp: "花見", kana: "はなみ", cn: "赏樱、赏花", pos: "名詞" },
		{ jp: "機会", kana: "きかい", cn: "机会", pos: "名詞" },
		{ jp: "同期生", kana: "どうきせい", cn: "同届同学", pos: "名詞" },
		{ jp: "駐車場", kana: "ちゅうしゃじょう", cn: "停车场", pos: "名詞" },
		{ jp: "転居通知", kana: "てんきょつうち", cn: "搬家通知", pos: "名詞" },
		{ jp: "新築", kana: "しんちく", cn: "新建（的房子）", pos: "名詞" },
		{ jp: "誘う", kana: "さそう", cn: "邀请", pos: "動詞" },
		{ jp: "招待する", kana: "しょうたいする", cn: "招待、邀请", pos: "動詞" },
		{ jp: "上司", kana: "じょうし", cn: "上司", pos: "名詞" },
	],
	...
	grammar: [
		{
			...
			example: { jp: "お{車|くるま}でおいでになる{場合|ばあい}", cn: "开车前来的情况" },
			note: "本课要点。这里的「おいでになる」＝「来る」。",
		},
		{
			pattern: "{参|まい}る（謙譲語）",
			meaning: "「行く・来る」的谦让语，用于自己一方。",
			example: { jp: "{駅|えき}まで{迎|むか}えに{参|まい}ります。", cn: "我会到车站迎接。" },
		},
		{
			pattern: "お{越|こ}しになる／お{越|こ}しください（尊敬語）",
			meaning: "「来る」的尊敬语。「ぜひお越しください」是邀请函的固定说法。",
			example: { jp: "ぜひお{越|こ}しください。", cn: "敬请务必光临。" },
		},
		{
			pattern: "〜ことにいたしました",
			formation: "動詞辞書形 ＋ ことにする（いたす＝する的谦让语）",
			meaning: "（我）决定……。自谦地宣布自己的决定。",
			example: { jp: "{花見|はなみ}の{会|かい}を{開|ひら}くことにいたしました。", cn: "我决定举办赏花会。" },
		},
		{
			pattern: "〜ませんか",
			meaning: "要不要……？表示邀请。",
			example: { jp: "{同期生|どうきせい}で{集|あつ}まりませんか。", cn: "同届同学要不要聚一聚？" },
		},
		{
			pattern: "〜ていただきたく",
			meaning: "想请您……（书面语，「〜ていただきたいので」的文语形式）。",
			example: { jp: "{皆様|みなさま}にもぜひ{見|み}ていただきたく", cn: "很想请各位也来看一看" },
		},
		{
			pattern: "なお",
			meaning: "另外、此外。补充说明时使用，第 1 週学过的信号词。",
			example: { jp: "なお、{電車|でんしゃ}でいらっしゃる{場合|ばあい}には……", cn: "另外，乘电车前来的话……" },
		},
	],
};
