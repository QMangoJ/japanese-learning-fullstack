		...
		groups: [
			{
				...
				blocks: [
					...
					},
					{
						type: "paragraph",
						indent: true,
						jp: "{場所|ばしょ}は{昨年|さくねん}と{同|おな}じく、たから{市民会館|しみんかいかん}ホール、{日時|にちじ}は5{月|がつ}3{日|にち}{午後|ごご}3{時|じ}よりを{予定|よてい}しておりますが、{先生|せんせい}のご{都合|つごう}はいかがでしょうか。{今回|こんかい}は「50{歳|さい}からの{生|い}き{方|かた}について」という{内容|ないよう}でお{願|ねが}いしたいと{思|おも}います。",
