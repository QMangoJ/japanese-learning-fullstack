...
export const w4d4: ReadingDay = {
	...
	renshu: {
		...
		choices: [
			{ jp: "{夫|おっと}は、{温泉旅行|おんせんりょこう}をしたがっている。", cn: "丈夫想去泡温泉旅行。" },
			{ jp: "この{広告|こうこく}には1{泊|ぱく}2{食付|しょくつ}きで8,000{円|えん}と{書|か}いてある。", cn: "这则广告上写着一晚含两餐 8,000 日元。" },
			{ jp: "{菜々|なな}の{分|ぶん}も{少|すこ}しだけ{払|はら}わなければならない。", cn: "菜菜的份也要付一点钱。" },
			{ jp: "{妻|つま}はすしの{食|た}べ{放題|ほうだい}には{興味|きょうみ}がない。", cn: "妻子对寿司自助没有兴趣。" },
			{ jp: "9{月|がつ}8{日|か}の{場合|ばあい}、1{人|にん}につき2,000{円|えん}ずつ{多|おお}くなる。", cn: "9 月 8 日的话，每人要多付 2,000 日元。" },
		],
		answers: [2, 5],
		hint: {
	...
	mondai: {
		...
		blocks: [
			{ type: "title", jp: "くりこま{高原|こうげん}　{天然|てんねん}の{温泉|おんせん}＊", cn: "栗驹高原　天然温泉＊" },
			{ type: "note", jp: "なんと{土曜日|どようび}も{同料金|どうりょうきん}！", cn: "竟然连星期六也是同一价格！" },
			{ type: "title", jp: "すし{食|た}べ{放題|ほうだい}!!　8,000{円|えん}", cn: "寿司随便吃!!　8,000 日元" },
			{ type: "line", jp: "（{消費税|しょうひぜい}・サービス{料込|りょうこ}み）", cn: "（含消费税・服务费）", align: "center" },
			{ type: "heading", jp: "お{一人様|ひとりさま}1{泊|ぱく}2{食付|しょくつき}", cn: "每位　1 晚含 2 餐" },
			{
				type: "line",
			...
			},
			{
				...
				marker: "＊",
				items: [
					{ jp: "9{月|がつ}7{日|か}、8{日|か}は2,000{円増|えんま}し", cn: "9 月 7 日、8 日加收 2,000 日元" },
					{
			...
			{ type: "line", jp: "ふじ{旅館|りょかん}（{全室和室|ぜんしつわしつ}）　0551-33-XXXX", cn: "富士旅馆（全部为和式房间）　0551-33-XXXX" },
			{ type: "line", jp: "{東京予約|とうきょうよやく}センター　TEL 03-3333-XXXX", cn: "东京预订中心　电话 03-3333-XXXX", align: "center" },
		],
		pageNotes: [{ jp: "＊ Natural Hot Spring", cn: "＊天然温泉" }],
		questions: [
			{
				label: "問1",
				...
				choices: [
					{ jp: "16,000{円|えん}", cn: "16,000 日元" },
					{ jp: "20,000{円|えん}", cn: "20,000 日元" },
					{ jp: "22,000{円|えん}", cn: "22,000 日元" },
					{ jp: "25,000{円|えん}", cn: "25,000 日元" },
				],
				answer: 2,
				explanation:
			...
			},
			{
				...
				choices: [
					{ jp: "ひとつの{部屋|へや}に{大人|おとな}1{人|にん}で{泊|と}まる{場合|ばあい}", cn: "一个房间只住 1 位成人的情况" },
					{ jp: "{家族|かぞく}3{人|にん}がすしを2{人前|にんまえ}ずつ{食|た}べた{場合|ばあい}", cn: "一家三口每人吃了 2 人份寿司的情况" },
					{
						jp: "9{月|がつ}12{日|にち}に{大人|おとな}2{人|ふたり}と{小学生|しょうがくせい}の{子|こ}ども2{人|ふたり}で{行|い}く{場合|ばあい}",
						cn: "9 月 12 日成人 2 位、小学生 2 名前往的情况",
					},
					{ jp: "{土曜日|どようび}に{大人|おとな}2{人|ふたり}と2{歳|さい}の{子|こ}ども1{人|ひとり}で{行|い}く{場合|ばあい}", cn: "星期六成人 2 位带 1 个 2 岁孩子前往的情况" },
				],
				answer: 1,
				explanation:
	...
	vocab: [
		{ jp: "広告", kana: "こうこく", cn: "广告", pos: "名詞" },
		{ jp: "情報", kana: "じょうほう", cn: "信息", pos: "名詞" },
		{ jp: "高原", kana: "こうげん", cn: "高原", pos: "名詞" },
		{ jp: "天然", kana: "てんねん", cn: "天然", pos: "名詞" },
		{ jp: "温泉", kana: "おんせん", cn: "温泉", pos: "名詞" },
		{ jp: "食べ放題", kana: "たべほうだい", cn: "随便吃、自助", pos: "名詞" },
		{ jp: "消費税", kana: "しょうひぜい", cn: "消费税", pos: "名詞" },
		{ jp: "〜込み", kana: "こみ", cn: "含〜（在内）", pos: "接尾語" },
		{ jp: "〜増し", kana: "まし", cn: "加收〜", pos: "接尾語" },
		{ jp: "半額", kana: "はんがく", cn: "半价", pos: "名詞" },
		{ jp: "無料", kana: "むりょう", cn: "免费", pos: "名詞" },
		{ jp: "旅館", kana: "りょかん", cn: "旅馆", pos: "名詞" },
		{ jp: "和室", kana: "わしつ", cn: "和式房间", pos: "名詞" },
		{ jp: "予約", kana: "よやく", cn: "预订", pos: "名詞・動詞" },
		{ jp: "〜人前", kana: "にんまえ", cn: "〜人份", pos: "助数詞" },
		{ jp: "興味", kana: "きょうみ", cn: "兴趣", pos: "名詞" },
		{ jp: "同料金", kana: "どうりょうきん", cn: "同样的价格", pos: "名詞" },
	],
	...
	grammar: [
		...
		},
		{
			...
			example: { jp: "すし{食|た}べ{放題|ほうだい}!!", cn: "寿司随便吃!!" },
		},
		{
			pattern: "〜込み／〜付き",
			meaning: "「込み」＝已包含在内；「付き」＝附带。价格表示的两个关键词。",
			example: { jp: "（{消費税|しょうひぜい}・サービス{料込|りょうこ}み）／1{泊|ぱく}2{食付|しょくつき}", cn: "（含消费税・服务费）／一晚含两餐" },
		},
		{
			pattern: "〜増し",
			meaning: "加收……。「2,000円増し」＝在原价基础上每人加 2,000 日元。",
			example: { jp: "9{月|がつ}7{日|か}、8{日|か}は2,000{円増|えんま}し", cn: "9 月 7 日、8 日加收 2,000 日元" },
		},
		{
			pattern: "〜たがる",
			formation: "動詞ます形 ＋ たがる",
			meaning: "（第三人称）想要……。表示别人的愿望。",
			example: { jp: "{夫|おっと}は、{温泉旅行|おんせんりょこう}をしたがっている。", cn: "丈夫想去泡温泉旅行。" },
		},
		{
			pattern: "〜につき",
			formation: "名詞 ＋ につき",
			meaning: "每……。表示单位。",
			example: { jp: "1{人|にん}につき2,000{円|えん}ずつ{多|おお}くなる", cn: "每人多付 2,000 日元" },
		},
		{
			pattern: "〜んだもん",
			meaning: "因为……嘛。口语，带撒娇或辩解的语气。",
			example: { jp: "いいじゃない。{安|やす}いんだもん。", cn: "有什么不好，多便宜嘛。" },
		},
	],
};
