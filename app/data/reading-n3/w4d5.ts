...
export const w4d5: ReadingDay = {
	...
	point: {
		...
		expressions: [
			...
			{ jp: "大小合わせて", kana: "だいしょうあわせて", cn: "大小加在一起（合计）" },
			{ jp: "〜に加え", kana: "くわえ", cn: "除〜之外还有" },
		],
	},
	...
	renshu: {
		...
		footnotes: [
			{ marker: "※1", term: "荷造り", jp: "packing", cn: "打包、装箱" },
			{ marker: "※2", term: "荷ほどき", jp: "unpacking", cn: "拆包、开箱" },
			{ marker: "※3", term: "標準", jp: "standard", cn: "标准" },
			{ marker: "※4", term: "節約", jp: "thrift", cn: "节约" },
			{ marker: "※5", term: "見積もり", jp: "a quote / estimate (of cost)", cn: "估价、报价" },
		],
		choices: [
			{ jp: "この{夫婦|ふうふ}は、{新|あたら}しい{家|いえ}についての{話|はなし}をしている。", cn: "这对夫妻在谈论新房子的事。" },
			{ jp: "この{夫婦|ふうふ}は、{引|ひ}っ{越|こ}し{料金|りょうきん}が{安|やす}いコースを{探|さが}している。", cn: "这对夫妻在找搬家费便宜的套餐。" },
			{ jp: "「らくらくコース」は、{楽|らく}に{引|ひ}っ{越|こ}しできるコースという{意味|いみ}である。", cn: "「轻松套餐」是指能轻松完成搬家的套餐。" },
			{ jp: "「{標準|ひょうじゅん}コース」より「らくらくコース」のほうが{安|やす}い。", cn: "「轻松套餐」比「标准套餐」便宜。" },
			{ jp: "この{夫婦|ふうふ}は、{今見|いまみ}ている{広告|こうこく}の{会社|かいしゃ}に{引|ひ}っ{越|こ}しを{頼|たの}むことに{決|き}めた。", cn: "这对夫妻决定把搬家委托给现在看的这家广告上的公司。" },
		],
		answers: [2, 3],
		hint: {
	...
	mondai: {
		...
		footnotes: [
			{ marker: "※1", term: "ダンボール（箱）", jp: "a cardboard box", cn: "瓦楞纸箱" },
			{ marker: "※2", term: "用意する", jp: "to prepare, provide with", cn: "准备" },
		],
		pageNotes: [
			{ jp: "＊ No need to worry if it's your first move!", cn: "＊第一次搬家也别担心！" },
		],
		questions: [
			{
				label: "問い",
	...
	vocab: [
		{ jp: "引っ越し", kana: "ひっこし", cn: "搬家", pos: "名詞" },
		{ jp: "業者", kana: "ぎょうしゃ", cn: "商家、公司", pos: "名詞" },
		{ jp: "見積もり", kana: "みつもり", cn: "估价、报价", pos: "名詞" },
		{ jp: "荷造り", kana: "にづくり", cn: "打包、装箱", pos: "名詞・動詞" },
		{ jp: "荷ほどき", kana: "にほどき", cn: "拆包、开箱", pos: "名詞・動詞" },
		{ jp: "標準", kana: "ひょうじゅん", cn: "标准", pos: "名詞" },
		{ jp: "節約", kana: "せつやく", cn: "节约", pos: "名詞・動詞" },
		{ jp: "コース", cn: "套餐、路线", pos: "名詞" },
		{ jp: "ダンボール", cn: "瓦楞纸箱", pos: "名詞" },
		{ jp: "大小", kana: "だいしょう", cn: "大小", pos: "名詞" },
		{ jp: "合わせて", kana: "あわせて", cn: "合计、加在一起", pos: "副詞" },
		{ jp: "無料", kana: "むりょう", cn: "免费", pos: "名詞" },
		{ jp: "約束する", kana: "やくそくする", cn: "承诺、约定", pos: "動詞" },
		{ jp: "基本", kana: "きほん", cn: "基本", pos: "名詞" },
		{ jp: "さまざま", cn: "各种各样", pos: "な形" },
		{ jp: "楽", kana: "らく", cn: "轻松", pos: "な形" },
		{ jp: "ただ", cn: "免费", pos: "名詞" },
		{ jp: "正確", kana: "せいかく", cn: "准确", pos: "な形" },
	],
	...
	grammar: [
		...
		},
		{
			...
			example: { jp: "ダンボールは{大小合|だいしょうあ}わせて50{個|こ}まで{無料|むりょう}です。", cn: "纸箱大小合计 50 个以内免费。" },
			note: "本课最大考点。若写成「大50個小50個」就是各 50 个、合计 100 个，意思完全不同。",
		},
		{
			pattern: "お／ご〜いただけます",
			meaning: "您可以……。尊敬地表示「对方可以做某事」，广告中常用。",
			example: { jp: "さまざまなコースからお{選|えら}びいただけます。", cn: "您可以从多种套餐中选择。" },
		},
		{
			pattern: "〜には{違|ちが}いない",
			meaning: "……是肯定的、确实……（但是）。后面常接转折。",
			example: { jp: "{楽|らく}には{違|ちが}いないけど、{高|たか}いのよ。", cn: "轻松是肯定轻松，可是很贵啊。" },
		},
		{
			pattern: "〜てもらう",
			meaning: "请（对方）为我做……。",
			example: { jp: "さっそく{見積|みつ}もりに{来|き}てもらおうよ。", cn: "赶紧请他们来估个价吧。" },
		},
		{
			pattern: "〜なんて",
			meaning: "……什么的、竟然……。表示轻视、意外或强调话题。",
			example: { jp: "{引|ひ}っ{越|こ}しなんて{初|はじ}めて、という{方|かた}も{大丈夫|だいじょうぶ}！", cn: "「搬家还是头一回」的朋友也不用担心！" },
		},
		{
			pattern: "{今|いま}なら",
			meaning: "现在的话（就有优惠）。广告里制造紧迫感的常用说法。",
			example: { jp: "{今|いま}なら、お{見積|みつ}もりをお{申|もう}し{込|こ}みの{方|かた}にプレゼントを……", cn: "现在申请估价的客户还可获赠礼品……" },
		},
	],
};
