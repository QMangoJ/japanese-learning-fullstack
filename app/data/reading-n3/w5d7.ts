...
export const w5d7: ReadingDay = {
		...
		groups: [
			{
				...
				blocks: [
					{ type: "paragraph", jp: "ポチの{鳴|な}き{声|ごえ}でぼくは{目|め}がさめた。", cn: "我被小波的叫声吵醒了。" },
					{
						type: "paragraph",
						indent: true,
					...
					{ type: "line", jp: "「おとうさん……おかあさん……。」と{思|おも}いきり{大|おお}きな{声|こえ}を{出|だ}した。", cn: "拼命地大喊：「爸爸……妈妈……」" },
					{
						type: "paragraph",
						indent: true,
					...
					{ type: "source", jp: "（{有島武郎|ありしまたけお}『{家事|かじ}とポチ』）", cn: "（有岛武郎《火灾与小波》）" },
				],
				footnotes: [
					{ marker: "※1", term: "布", jp: "ぬののこと", cn: "布" },
					{ marker: "※2", term: "ちがいだな", jp: "床の間などにある高さの違う2枚の棚", cn: "错落架（壁龛旁高低错落的两层架子）" },
					{ marker: "※3", term: "影法師", jp: "影のこと", cn: "影子" },
					{
						marker: "※4",
						term: "化け物",
					...
					{ marker: "※5", term: "離れ", jp: "同じ家だが、少し離れて建てた部屋", cn: "偏屋（同一宅院内另建的房间）" },
					{ marker: "※6", term: "寝巻き", jp: "寝るとき着る物", cn: "睡衣" },
				],
				questions: [
					{
						label: "1",
						...
						cn: "①「两次」指的是什么时候和什么时候？",
						choices: [
							{ jp: "{目|め}が{覚|さ}めたときとねむたくてたまらなかったとき", cn: "醒来时和困得不行时" },
							{ jp: "{起|お}きたときと{戸|と}だなを{開|あ}けたとき", cn: "起床时和打开壁橱时" },
							{ jp: "ポチを{見|み}たときとおばあさまを{見|み}たとき", cn: "看到小波时和看到奶奶时" },
							{
					...
					},
					{
						...
						cn: "是谁、为了什么在②「拍打火」？",
						choices: [
							{ jp: "おばあさまが{料理|りょうり}をするために", cn: "奶奶为了做饭" },
							{ jp: "ポチが{火事|かじ}を{知|し}らせるために", cn: "小波为了通知失火" },
							{ jp: "おばあさまが{火|ひ}を{消|け}すために", cn: "奶奶为了灭火" },
							{ jp: "ポチが{怪物|かいぶつ}と{戦|たたか}うために", cn: "小波为了和怪物搏斗" },
						],
						answer: 3,
						explanation:
					...
					},
					{
						...
						choices: [
							{ jp: "ポチがいつのまにかそばに{来|き}ていること", cn: "小波不知不觉来到了身边" },
							{ jp: "おばあさまが{火事|かじ}を{起|お}こしたこと", cn: "奶奶引起了火灾" },
							{ jp: "{離|はな}れにお{父|とう}さんとお{母|かあ}さんがいること", cn: "父母在偏屋里" },
							{ jp: "おばあさまが{火事|かじ}を{一人|ひとり}で{消|け}そうとしていること", cn: "奶奶正一个人想把火扑灭" },
						],
						answer: 4,
						explanation:
					...
					},
					{
						...
						choices: [
							{ jp: "ねむくてたまらないようす", cn: "困得不行的样子" },
							{ jp: "ショックを{受|う}けているようす", cn: "受到强烈冲击的样子" },
							{ jp: "{感動|かんどう}しているようす", cn: "深受感动的样子" },
							{ jp: "おもしろがっているようす", cn: "觉得有趣的样子" },
						],
						answer: 2,
						explanation:
	...
	vocab: [
		{ jp: "鳴き声", kana: "なきごえ", cn: "（动物的）叫声", pos: "名詞" },
		{ jp: "目がさめる", kana: "めがさめる", cn: "醒来", pos: "表現" },
		{ jp: "真っ赤", kana: "まっか", cn: "通红", pos: "な形" },
		{ jp: "映る", kana: "うつる", cn: "映入、映照", pos: "動詞" },
		{ jp: "戸だな", kana: "とだな", cn: "壁橱、橱柜", pos: "名詞" },
		{ jp: "飛び起きる", kana: "とびおきる", cn: "一跃而起", pos: "動詞" },
		{ jp: "夢中になる", kana: "むちゅうになる", cn: "入迷、拼命", pos: "表現" },
		{ jp: "たたく", cn: "拍打", pos: "動詞" },
		{ jp: "障子", kana: "しょうじ", cn: "纸拉门", pos: "名詞" },
		{ jp: "床の間", kana: "とこのま", cn: "壁龛", pos: "名詞" },
		{ jp: "影法師", kana: "かげぼうし", cn: "影子", pos: "名詞" },
		{ jp: "化け物", kana: "ばけもの", cn: "妖怪", pos: "名詞" },
		{ jp: "火事", kana: "かじ", cn: "火灾", pos: "名詞" },
		{ jp: "離れ", kana: "はなれ", cn: "偏屋", pos: "名詞" },
		{ jp: "思いきり", kana: "おもいきり", cn: "尽情地、拼命地", pos: "副詞" },
		{ jp: "いつのまにか", cn: "不知不觉间", pos: "副詞" },
		{ jp: "寝巻き", kana: "ねまき", cn: "睡衣", pos: "名詞" },
		{ jp: "ないしょ話", kana: "ないしょばなし", cn: "悄悄话", pos: "名詞" },
		{ jp: "両肩", kana: "りょうかた", cn: "双肩", pos: "名詞" },
		{ jp: "納得する", kana: "なっとくする", cn: "认可、接受", pos: "動詞" },
		{ jp: "ぜいたく", cn: "奢侈", pos: "な形" },
		{ jp: "食器", kana: "しょっき", cn: "餐具", pos: "名詞" },
		{ jp: "結局", kana: "けっきょく", cn: "结果、最终", pos: "副詞" },
	],
	...
	grammar: [
		{
			pattern: "〜てたまらない",
			meaning: "……得受不了。",
			example: { jp: "ねむたくてたまらなかった", cn: "困得受不了" },
		},
		{
			pattern: "〜まもなく",
			formation: "動詞辞書形／て形 ＋ まもなく",
			meaning: "刚……不久就……。",
			example: { jp: "その{鳴|な}き{声|ごえ}をおこっているまもなく", cn: "正生着气呢，紧接着就……" },
		},
		{
			pattern: "〜はずの／〜はずだ",
			meaning: "应该……。表示按道理推断。",
			example: { jp: "ぼくのそばに{寝|ね}ているはずのおばあさま", cn: "本该睡在我旁边的奶奶" },
		},
		{
			pattern: "〜（よ）うとする",
			formation: "動詞意向形 ＋ とする",
			meaning: "想要……、正打算……。",
			example: { jp: "おばあさまが{一人|ひとり}で{消|け}そうとしているんだ。", cn: "奶奶正一个人想把火扑灭。" },
		},
		{
			pattern: "〜か〜ないかに",
		...
		},
		{
			...
			meaning: "只……（就没有下文了）。",
			example: { jp: "「たいへんなの。」きりであとは{声|こえ}が{出|で}なかった。", cn: "只说得出「不得了了」，后面再也发不出声。" },
		},
		{
			pattern: "〜のまま",
			meaning: "保持……的状态。",
			example: { jp: "おかあさんが{寝巻|ねま}きのままで{飛|と}び{出|だ}してきた。", cn: "母亲穿着睡衣就冲了出来。" },
		},
		{
			pattern: "〜ようす（だ）",
			meaning: "看起来……的样子。用于描写他人的状态。",
			example: { jp: "{妻|つま}は、{満足|まんぞく}したようすでした。", cn: "妻子看上去满足了。" },
		},
	],
};
