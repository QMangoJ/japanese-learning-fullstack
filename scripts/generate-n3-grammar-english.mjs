...
const WEEKLY_DETAIL_EN = {
  "w1-mondai1-0": { why_en: ["", "", "", ""], option_translations_en: ["Stopped by someone / being stopped", "Let me stop / have someone stop (causative of transitive verb)", "Have someone stop (causative of intransitive verb)", "Suffer someone stopping (adversative passive)"] },
  "w1-mondai1-1": { why_en: ["", "", "", ""], option_translations_en: ["Incorrect volitional form (should be 「直そう」)", "(Something) is about to return to its original state (volitional of intransitive verb)", "Intend to correct / try to correct", "Incorrect conjugation form"] },
  "w1-mondai1-10": { why_en: ["", "", "", ""], option_translations_en: ["With a feeling of...", "Like... (attributive form)", "In a way fitting for... / Characteristic of...", "Like... (adverbial form)"] },
  "w1-mondai1-11": { why_en: ["", "", "", ""], option_translations_en: ["Use (て-form)", "Let's use / intend to use", "Do not use", "Make an effort to use / be required to use"] },
  "w1-mondai1-12": { why_en: ["", "", "", ""], option_translations_en: ["Too watery / diluted like water", "Not too watery / not diluted", "The way water should be", "Not the way water should be"] },
  "w1-mondai1-13": { why_en: ["「ついといて」is a colloquial contraction of 「ついておいて」. 「つく」is an intransitive verb meaning the TV is in an on state, and cannot express asking someone to turn it off.", "「消しといて」is a colloquial contraction of 「消しておいて」. 「消す」in the context of a TV means 'turn off,' which fits both grammatically and semantically with 'if not watching, turn it off.'", "「つけといて」is a colloquial contraction of 「つけておいて」, meaning 'turn on in advance / keep on,' which is the opposite of what is requested after 'not watching TV.'", "「消えといて」is a colloquial contraction of 「消えておいて」. 「消える」is an intransitive verb meaning the TV turns off by itself or is in an off state; here a transitive verb 「消す」is needed to ask someone to turn off the TV."], option_translations_en: ["Left on / in an on state (colloquial contraction of 「ついておいて」, unnatural here)", "Turn off in advance / leave off (colloquial contraction of 「消しておいて」)", "Turn on in advance / keep on (colloquial contraction of 「つけておいて」)", "Go out / be in an off state (colloquial contraction of 「消えておいて」, unnatural here)"] },
  "w1-mondai1-14": { why_en: ["", "", "", ""], option_translations_en: ["If let stay", "If made to stay there (adversative passive nuance)", "If not let stay / must let stay", "If cannot stay"] },
  "w1-mondai1-2": { why_en: ["", "", "", ""], option_translations_en: ["Have someone cut/disconnect", "Cut/disconnected in advance (colloquial contraction of 「切っておいた」)", "Must cut/disconnect", "Got cut off / line went dead (colloquial of 「切れてしまった」)"] },
  "w1-mondai1-3": { why_en: ["", "", "", ""], option_translations_en: ["For the purpose of... / Because of...", "So as to be able to... / Like...", "In a way fitting for... / Characteristic of...", "It seems... / It looks like..."] },
  "w1-mondai1-4": { why_en: ["", "", "", ""], option_translations_en: ["Cannot buy", "Buy", "Do not buy", "Can buy"] },
  "w1-mondai1-5": { why_en: ["", "", "", ""], option_translations_en: ["Like... (attributive form)", "Like... (adverbial form)", "A nominalized 'one that looks like ...'; it cannot directly modify the following noun", "Like... (colloquial of 「みたいに」)"] },
  "w1-mondai1-6": { why_en: ["", "", "", ""], option_translations_en: ["Incorrect phonological form", "Incorrect phonological form", "Died (colloquial of 「死んでしまった」)", "Will die (colloquial of 「死んでしまう」)"] },
  "w1-mondai1-7": { why_en: ["", "", "", ""], option_translations_en: ["If one is made to...", "If one does... (colloquial of てしまう)", "Must do / have to do", "If prepared in advance..."] },
  "w1-mondai1-8": { why_en: ["", "", "", ""], option_translations_en: ["Is told / is notified", "Is notifying / telling", "Is well known", "Make someone notify (redundant causative, inappropriate form)"] },
  "w1-mondai1-9": { why_en: ["", "", "", ""], option_translations_en: ["Incorrect conjugation form", "Let's take a shower / intend to take a shower (volitional of 「浴びる」)", "Incorrect conjugation form", "Incorrect conjugation form"] },
  "w1-mondai2-0": { why_en: ["", "", "", ""], option_translations_en: ["In many countries (as topic)", "Cars (as topic)", "Export", "Manufactured"] },
  "w1-mondai2-1": { why_en: ["", "", "", ""], option_translations_en: ["Became cheerful", "So as to be able to... / Like...", "Since becoming...", "Understand / can understand"] },
  "w1-mondai2-2": { why_en: ["", "", "", ""], option_translations_en: ["Even though... / Although...", "Wrote a note in advance (colloquial contraction of 「メモしておいた」)", "Because it won't work / because of trouble", "That note (as object)"] },
  "w1-mondai2-3": { why_en: ["", "", "", ""], option_translations_en: ["Adult (as object)", "Child", "Adopt a way of speaking", "Like... (attributive form)"] },
  "w1-mondai2-4": { why_en: ["", "", "", ""], option_translations_en: ["Shirt (as object)", "Was bought", "Had originally intended / had thought", "By someone else / to someone else"] },
  "w1-mondai3-0": { why_en: ["", "", "", ""], option_translations_en: ["Became able to go / started going", "Tried to go / was about to go", "Had someone go", "Was gone (adversative passive) / went (honorific)"] },
  "w1-mondai3-1": { why_en: ["", "", "", ""], option_translations_en: ["Had someone move / was able to move", "Was moved (adversative passive)", "Became able to move", "Would not move / showed no intention of moving"] },
  "w1-mondai3-2": { why_en: ["", "", "", ""], option_translations_en: ["Do not enter", "Please let me in", "Must enter / if not entering", "Was entered (adversative passive)"] },
  "w1-mondai3-3": { why_en: ["", "", "", ""], option_translations_en: ["Got off", "Incorrect volitional form (should be 「降りよう」)", "Intend to get off / want to get off", "Get off (polite form)"] },
  "w1-mondai3-4": { why_en: ["", "", "", ""], option_translations_en: ["Enter", "Put in / let in", "Do not enter", "Cannot enter / not let in"] },
  "w2-mondai1-0": { why_en: ["", "", "", ""], option_translations_en: ["Or rather... / to be more precise...", "Due to... / through... / according to...", "Always... / nothing but...", "Only... (followed by negative)"] },
  "w2-mondai1-1": { why_en: ["", "", "", ""], option_translations_en: ["Always... / nothing but...", "Even... / as long as...", "It is precisely... (emphatic)", "Only / merely"] },
  "w2-mondai1-10": { why_en: ["", "", "", ""], option_translations_en: ["Although... / but...", "Rather than... it's more like...", "Speaking of... / when it comes to...", "Speaking of..."] },
  "w2-mondai1-11": { why_en: ["", "", "", ""], option_translations_en: ["Due to... / through... / according to...", "According to...", "Caused by... / based on...", "About..."] },
  "w2-mondai1-12": { why_en: ["", "", "", ""], option_translations_en: ["Due to... / through... / according to...", "According to...", "Due to... / through...", "Caused by... / based on..."] },
  "w2-mondai1-13": { why_en: ["", "", "", ""], option_translations_en: ["Although I understand", "Because I understand (with explanatory tone)", "Precisely because I don't know", "If only I didn't know (unnatural)"] },
  "w2-mondai1-14": { why_en: ["", "", "", ""], option_translations_en: ["Accordingly / based on that", "Regarding this matter", "In this way / by doing so", "On that point however..."] },
  "w2-mondai1-2": { why_en: ["", "", "", ""], option_translations_en: ["Based on... / close to...", "About... (after 「に」) / follow", "Related to...", "Even... / as long as..."] },
  "w2-mondai1-3": { why_en: ["", "", "", ""], option_translations_en: ["Degree of coldness / coldness (noun)", "Incorrect noun form", "Cold (ren'yōkei / continuative form)", "Cold"] },
  "w2-mondai1-4": { why_en: ["", "", "", ""], option_translations_en: ["Only / merely", "Always... / nothing but...", "Even... / as long as...", "It is precisely... (emphatic)"] },
  "w2-mondai1-5": { why_en: ["", "", "", ""], option_translations_en: ["Nominalizes the preceding clause as object", "Nominalizes the preceding clause as subject", "Even though... / although...", "Because..."] },
  "w2-mondai1-6": { why_en: ["", "", "", ""], option_translations_en: ["Eat (dictionary form)", "Eat (ren'yōkei / continuative form)", "Eat (て-form)", "Eat! (imperative form)"] },
  "w2-mondai1-7": { why_en: ["", "", "", ""], option_translations_en: ["If not... / must...", "Let someone do / please allow me to do", "Try doing (used for urging)", "Do completely / finish doing (colloquial contraction of 「てしまって」)"] },
  "w2-mondai1-8": { why_en: ["", "", "", ""], option_translations_en: ["Degree of quietness (noun form of 「静か」)", "Incorrect noun form", "Seems quiet (word formation is inappropriate here)", "Feels somewhat quiet"] },
  "w2-mondai1-9": { why_en: ["", "", "", ""], option_translations_en: ["Make an effort to... / form a habit of...", "After becoming able to... / because of becoming...", "Tell someone to... / ask someone to...", "Do not try to..."] },
  "w2-mondai2-0": { why_en: ["", "", "", ""], option_translations_en: ["One person", "Only... (followed by negative)", "Person (as topic)", "Can speak / able to speak"] },
  "w2-mondai2-1": { why_en: ["", "", "", ""], option_translations_en: ["The so-called... / what is called...", "Tried doing / saw", "...is (topic or contrast marker)", "...'s (nominalizes the preceding clause)"] },
  "w2-mondai2-2": { why_en: ["", "", "", ""], option_translations_en: ["Nominalizes the preceding clause as object", "So as to be able to... / like...", "Bring", "Tell / ask"] },
  "w2-mondai2-3": { why_en: ["", "", "", ""], option_translations_en: ["Television (as object)", "Do not watch", "Please do... for me / please do... on my behalf", "At... volume / with... sound"] },
  "w2-mondai2-4": { why_en: ["", "", "", ""], option_translations_en: ["Worry", "Tsunami's (attributive)", "Caused by... / based on...", "To / at / for (particle)"] },
  "w2-mondai3-0": { why_en: ["", "", "", ""], option_translations_en: ["According to...", "The so-called... / what is called...", "Rather than... it's more like...", "Speaking of..."] },
  "w2-mondai3-1": { why_en: ["", "", "", ""], option_translations_en: ["That's not the case", "It seems that is indeed the case", "Think that is probably so", "I hear that is so"] },
  "w2-mondai3-2": { why_en: ["", "", "", ""], option_translations_en: ["Although... / but...", "Even... / as long as...", "Only... (followed by negative)", "Due to... / through... / according to..."] },
  "w2-mondai3-3": { why_en: ["", "", "", ""], option_translations_en: ["Always... / nothing but...", "Rather than... it's more like...", "It is precisely... (emphatic)", "About..."] },
  "w2-mondai3-4": { why_en: ["", "", "", ""], option_translations_en: ["About the matter of...", "The so-called... / what is called...", "Always... / nothing but...", "Although... / but..."] },
  "w3-mondai1-0": { why_en: ["", "", "", ""], option_translations_en: ["Every time...", "While doing... / on the occasion of...", "According to... / as...", "As it is / left as is"] },
  "w3-mondai1-1": { why_en: ["", "", "", ""], option_translations_en: ["Incorrect form (should be 「もらいたい」)", "Want me to... (unnatural conjugation here)", "Want the other person to do something for me", "Could you do... for me / won't you do... for me"] },
  "w3-mondai1-10": { why_en: ["", "", "", ""], option_translations_en: ["For... / as for...", "As...", "If... / supposing...", "From the standpoint of..."] },
  "w3-mondai1-11": { why_en: ["", "", "", ""], option_translations_en: ["Leave (ren'yōkei / continuative form)", "Leave (て-form)", "Leave (dictionary form)", "Left"] },
  "w3-mondai1-12": { why_en: ["", "", "", ""], option_translations_en: ["Turn on / light (ren'yōkei / continuative form)", "Turned on / lit (for appliances, fire)", "(Fire or appliance) is on / lit (intransitive)", "Turn on / light / install (て-form)"] },
  "w3-mondai1-13": { why_en: ["", "", "", ""], option_translations_en: ["Every time it's like this", "On that point however...", "If that is the case", "Even so / be that as it may"] },
  "w3-mondai1-14": { why_en: ["", "", "", ""], option_translations_en: ["Should be here", "Should not be here", "Cannot possibly not be here", "Should not be here"] },
  "w3-mondai1-2": { why_en: ["", "", "", ""], option_translations_en: ["For... yet...", "Should...", "Just as... / according to...", "Rather than... it's more like..."] },
  "w3-mondai1-3": { why_en: ["", "", "", ""], option_translations_en: ["When I go... / if I go", "If I go", "After going / if going", "If I were to go"] },
  "w3-mondai1-4": { why_en: ["", "", "", ""], option_translations_en: ["Too... / due to being too...", "It makes one... / deciding to...", "The moment... / as soon as...", "In the end... / as a result... (often with undesirable outcome)"] },
  "w3-mondai1-5": { why_en: ["", "", "", ""], option_translations_en: ["Should be...", "Nothing more than... / merely...", "...unbearably / intolerably", "Depends on... / the case is..."] },
  "w3-mondai1-6": { why_en: ["", "", "", ""], option_translations_en: ["If I hear / after hearing", "Even if I hear", "Every time I hear / if I hear then...", "If I hear / as soon as I hear..."] },
  "w3-mondai1-7": { why_en: ["", "", "", ""], option_translations_en: ["Really want to do...", "Even to the point of doing...", "No wonder one doesn't / meaning one doesn't", "Used to do... (past habit)"] },
  "w3-mondai1-8": { why_en: ["", "", "", ""], option_translations_en: ["Do... and... (without doing)", "Incorrect form (should be 「ささずに」 for 「傘を差す」)", "Incorrect conjugation form", "Without opening (an umbrella) and..."] },
  "w3-mondai1-9": { why_en: ["", "", "", ""], option_translations_en: ["While doing... / on the occasion of...", "Every time...", "Since... / only...", "According to... / as..."] },
  "w3-mondai2-0": { why_en: ["", "", "", ""], option_translations_en: ["Does not know", "Just... / merely...", "Is doing / has been doing", "Pretend for a moment"] },
  "w3-mondai2-1": { why_en: ["", "", "", ""], option_translations_en: ["Study", "Intend / plan", "Do not sleep", "Even though it was the case"] },
  "w3-mondai2-2": { why_en: ["", "", "", ""], option_translations_en: ["Be / exist", "Count (て-form)", "Do not talk to me", "While... is being done"] },
  "w3-mondai2-3": { why_en: ["", "", "", ""], option_translations_en: ["Should be", "According to... / as...", "Made", "Had someone do... / received"] },
  "w3-mondai2-4": { why_en: ["", "", "", ""], option_translations_en: ["Husband and wife", "Only... / since...", "We", "Two people"] },
  "w3-mondai3-0": { why_en: ["", "", "", ""], option_translations_en: ["Is not afraid (third-person expression)", "Feels afraid (third-person expression)", "Make someone afraid", "Is not afraid / not frightening"] },
  "w3-mondai3-1": { why_en: ["", "", "", ""], option_translations_en: ["Should...", "Intend / plan", "Should be the case", "Just as... / according to..."] },
  "w3-mondai3-2": { why_en: ["", "", "", ""], option_translations_en: ["Every time...", "According to... / as...", "The moment... / as soon as...", "While doing... / on the occasion of..."] },
  "w3-mondai3-3": { why_en: ["", "", "", ""], option_translations_en: ["Left unfinished and...", "After doing... and then...", "The moment one does...", "Every time one does..."] },
  "w3-mondai3-4": { why_en: ["", "", "", ""], option_translations_en: ["Want someone to observe / follow", "Want someone not to observe / follow", "Should observe / follow", "Intend to observe / follow"] },
  "w4-mondai1-0": { why_en: ["", "", "", ""], option_translations_en: ["Instead of...", "Instead of...", "Compared with... but...", "Due to... (negative cause)"] },
  "w4-mondai1-1": { why_en: ["", "", "", ""], option_translations_en: ["Thanks to...", "Compared with... but... / although... but...", "While doing... / on the occasion of...", "Instead of... / in exchange for..."] },
  "w4-mondai1-10": { why_en: ["", "", "", ""], option_translations_en: ["Should... / the fact that...", "It's not the case that... (colloquial)", "How...! (exclamatory)", "No need to... / nothing is more... than..."] },
  "w4-mondai1-11": { why_en: ["", "", "", ""], option_translations_en: ["Even though... but...", "To think that... / ...or something (showing surprise or disdain)", "...or something (showing disdain or giving an example)", "Compared with... but... / although... but..."] },
  "w4-mondai1-12": { why_en: ["", "", "", ""], option_translations_en: ["To the extent of... / about", "To the extent of... / the more... the more...", "As long as... / within the scope of...", "Even... / as long as..."] },
  "w4-mondai1-13": { why_en: ["", "", "", ""], option_translations_en: ["Should... / the fact that...", "How could... / absolutely not... (strong negation)", "Although... but...", "No need to... / nothing is more... than..."] },
  "w4-mondai1-14": { why_en: ["", "", "", ""], option_translations_en: ["Because... (colloquial, explanatory)", "How could... / absolutely not... (colloquial, strong negation)", "...or something (showing disdain or giving an example)", "How...! (exclamatory)"] },
  "w4-mondai1-2": { why_en: ["", "", "", ""], option_translations_en: ["Should say... / the so-called...", "Had better not say...", "How much one can say! (exclamatory)", "It's not that one doesn't say"] },
  "w4-mondai1-3": { why_en: ["", "", "", ""], option_translations_en: ["Even though... but...", "Compared with... but...", "...or something (showing disdain or giving an example)", "Because... (colloquial, explanatory)"] },
  "w4-mondai1-4": { why_en: ["", "", "", ""], option_translations_en: ["As... changes", "As long as... / within the scope of...", "To the extent of... / about", "During... / within..."] },
  "w4-mondai1-5": { why_en: ["", "", "", ""], option_translations_en: ["To the extent of... / the more... the more...", "To the extent of... / about", "Even... / as long as...", "As long as... / within the scope of..."] },
  "w4-mondai1-6": { why_en: ["", "", "", ""], option_translations_en: ["How...! (exclamatory)", "How could... / absolutely not... (strong negation)", "Have no choice but to...", "No need to... / nothing is more... than..."] },
  "w4-mondai1-7": { why_en: ["", "", "", ""], option_translations_en: ["Thing / used for general statements or exclamations", "It is precisely... (emphatic)", "Was it...? (recalling / confirming)", "How...! (exclamatory)"] },
  "w4-mondai1-8": { why_en: ["", "", "", ""], option_translations_en: ["How could... / absolutely not... (strong negation)", "Have no choice but to...", "Should... / the fact that...", "In other words... / it is said that..."] },
  "w4-mondai1-9": { why_en: ["", "", "", ""], option_translations_en: ["How...! (exclamatory)", "Should... / the fact that...", "How could... / absolutely not... (strong negation)", "Have no choice but to..."] },
  "w4-mondai2-0": { why_en: ["", "", "", ""], option_translations_en: ["Joy (as topic)", "Students' (attributive)", "For... (in relation to)", "Greatest"] },
  "w4-mondai2-1": { why_en: ["", "", "", ""], option_translations_en: ["Feelings / sentiment (as object)", "Endured", "Lonely (attributive)", "Thing / nominalizes the preceding clause"] },
  "w4-mondai2-2": { why_en: ["", "", "", ""], option_translations_en: ["War (as subject)", "Be / exist", "It is... (explanatory tone)", "Continuing (て-form)"] },
  "w4-mondai2-3": { why_en: ["", "", "", ""], option_translations_en: ["Able to contact", "Anytime / anywhere", "Because of... (negative cause)", "Become able to... / start..."] },
  "w4-mondai2-4": { why_en: ["", "", "", ""], option_translations_en: ["It's interesting, so...", "It is... (explanatory tone)", "Cannot stop", "Because... / but..."] },
  "w4-mondai3-0": { why_en: ["", "", "", ""], option_translations_en: ["So / therefore (taking action in response to the above)", "As a result / therefore", "Therefore / so", "Because / the reason is..."] },
  "w4-mondai3-1": { why_en: ["", "", "", ""], option_translations_en: ["Instead of...", "In other words", "Therefore / so", "Compared with that however..."] },
  "w4-mondai3-2": { why_en: ["", "", "", ""], option_translations_en: ["Compared with... but...", "Thanks to...", "Due to... / through...", "For... / to..."] },
  "w4-mondai3-3": { why_en: ["", "", "", ""], option_translations_en: ["Even so", "Therefore / for that reason", "Moreover / in addition", "However / but"] },
  "w4-mondai3-4": { why_en: ["", "", "", ""], option_translations_en: ["As a result / therefore", "Because / the reason is...", "While doing... / on the occasion of...", "However / but"] },
  "w5-mondai1-0": { why_en: ["「に対して」 means 'toward' (indicating a target), and cannot express comparison", "「について」 introduces a topic ('about'), but this sentence compares two groups", "「代わって」 means 'in place of,' but no person or thing is being replaced in this comparison", "「くらべて」 means 'compared with.' The pattern 「AにくらべてB」 = 'compared with A, B...' — correct"], option_translations_en: ["Toward... / relative to...", "About... / related to...", "Instead of... (て-form of 「代わる」)", "Compared with..."] },
  "w5-mondai1-1": { why_en: ["「たとえ～ても」 is a fixed pattern meaning 'even if.' 'Even if told so...' — correct", "'The moment one is told...' indicates an instantaneous action, which does not pair with 「たとえ」", "'Left in the state of being told' does not make sense semantically", "'If told so' is a conditional, but it does not pair with 「たとえ」"], option_translations_en: ["Even if told so", "The moment one is told... / as soon as...", "Left in the state of being told", "If told so"] },
  "w5-mondai1-10": { why_en: ["Interrogative form, which does not match the exclamatory tone of 「なあ」", "'I want to become' — the subject does not make sense ('spring' cannot have volition)", "If it were 「ならないかなあ」 (= hope it becomes) it would work, but 「ならない」 alone does not", "「～ばいい」+「なあ」 = 'if only it would...' (expressing a wish). Correct"], option_translations_en: ["Will it become...?", "Want to become...", "Does not become / will not become", "If only it would become..."] },
  "w5-mondai1-11": { why_en: ["「たとえ～でも」 = 'even if...'. Correct", "「必ずしも」 requires a partial negative such as 「とは限らない」, not the following 「ても」 clause", "「つまり」 restates a conclusion, whereas the sentence introduces a hypothetical concession", "「もしかすると」 marks an uncertain guess, whereas the sentence uses the concessive pattern 「たとえ～ても」"], option_translations_en: ["Even / even if", "Not necessarily / not always", "In other words", "Maybe / perhaps"] },
  "w5-mondai1-12": { why_en: ["「かわりに」 means 'instead of'", "「に対して」 means 'toward / for'", "Here it expresses contrast: 「Aなのに対してB」 = 'A, whereas/in contrast B.' Correct", "「はもちろん」 means '...goes without saying / of course'"], option_translations_en: ["Instead of...", "For... / to...", "Whereas... / in contrast to...", "...goes without saying / of course"] },
  "w5-mondai1-13": { why_en: ["「いいこと」 is a noun phrase and cannot complete the fixed wish pattern after 「～ば」", "'Maybe it would be nice' does not form the fixed 「～ばいいのに」 expression", "The past form 「よかった」 cannot follow 「～ば」 to form this wish expression", "「～ばいいのに」 = 'if only... (expressing regret or a wish).' Correct"], option_translations_en: ["A good thing (noun phrase)", "Maybe not bad", "Was good / would have been good", "If only... had / it would be nice if..."] },
  "w5-mondai1-14": { why_en: ["「動詞/形容詞＋の」 nominalizes the clause: 「品質がいいのはもちろん」 = 'the fact that the quality is good goes without saying.' Correct", "Not nominalized; cannot directly precede 「はもちろん」", "Adverbial form; grammatically incompatible", "If it were 「品質のよさはもちろん」 it would work, but here the preceding text is '品質が,' so 'よさ' cannot directly follow"], option_translations_en: ["The fact that it is good (nominalization)", "Good; of good quality", "Often / properly", "Goodness / merit"] },
  "w5-mondai1-2": { why_en: ["No such fixed collocation exists", "No such fixed collocation exists", "No such fixed collocation exists", "「数え切れない」 = 'countless / too many to count,' a fixed collocation — correct"], option_translations_en: ["Incorrect conjugation (the form 「数えたてない」 does not exist)", "Incorrect conjugation (「数えかけない」 here does not mean 'countless')", "Not done completely; however 「数え上げない」 here does not mean 'countless'", "Cannot count all of... / innumerable"] },
  "w5-mondai1-3": { why_en: ["「まるで」 means 'just like / as if,' which does not pair with 「とは限らない」", "「必ずしも～とは限らない」 = 'not necessarily...' — a fixed collocation. Correct", "「たとえ」 requires a concessive ending such as 「ても」, not 「とは限らない」", "「もしかすると」 means 'maybe,' which does not pair with 「とは限らない」"], option_translations_en: ["Just like / as if", "Not necessarily / not always", "Even / even if", "Maybe / perhaps"] },
  "w5-mondai1-4": { why_en: ["「ばかり」 means 'only / merely,' which is semantically opposite", "Cannot be used directly after a noun in this way", "「Aばかりか、Bも」 = 'not only A but also B' (additive progression). Correct", "「しか」 means 'only' (followed by negative), which is semantically opposite"], option_translations_en: ["Always... / nothing but...", "Of course / needless to say", "Not only... but also...", "Only... (followed by negative)"] },
  "w5-mondai1-5": { why_en: ["「～ておけばよかった」 = 'I should have done... in advance' (expressing regret). Correct", "'Should have already done' (conjecture), which does not fit the context", "'Do not intend to do in advance' does not make sense", "'Left unfinished and continuing' does not make sense"], option_translations_en: ["Should have done in advance (expressing regret)", "Should have already done (conjecture)", "Do not intend to do in advance", "Left unfinished and continuing"] },
  "w5-mondai1-6": { why_en: ["「において」 means 'in / at' (location, formal), equivalent to 「で」. Correct", "「について」 means 'about'", "「によって」 means 'due to / through / according to'", "「に対して」 means 'toward / for'"], option_translations_en: ["In / at... (location / field, written style)", "About...", "Due to... / through... / according to...", "For... / to..."] },
  "w5-mondai1-7": { why_en: ["「にしたがって」 means 'according to / in accordance with'", "「せいで」 means 'due to' (negative cause)", "「～までに」 means 'until... / to the point of...' (indicating extent). Correct", "「～から～にかけて」 requires pairing with 「から」"], option_translations_en: ["Just as... / according to...", "Because of... (negative cause)", "Until... / to the extent of...", "From... to... (requires pairing with 「から」)"] },
  "w5-mondai1-8": { why_en: ["「ついでに」 means 'while doing / by the way'", "「に対して」 means 'in contrast to'", "「どれだけ」 requires pairing with 「ても」", "「まるで～ように」 = 'just like... / as if...'. Correct"], option_translations_en: ["While doing... / on the occasion of...", "Compared with... but... / although... but...", "No matter how... (requires 「ても」)", "Just like... / as if..."] },
  "w5-mondai1-9": { why_en: ["「～てから」 means 'since... after'", "「動詞ます形＋たて」 = 'just done...' 'ぬりたて' = 'just painted.' Correct", "No such usage exists", "「～たまま」 means 'left in a state of...' which does not work grammatically here"], option_translations_en: ["Since... / only...", "Just finished doing...", "Completely... (stem of 「切れる」)", "Left as is / as it is"] },
  "w5-mondai2-0": { why_en: ["The other end of the range, placed between 「から」 and 「にかけて」; also valid if swapped with 「北海道」", "★ position. The first half of 「AからBにかけて」, following the starting point. Correct", "One end of the range, placed at the beginning as the starting point", "Fixed pairing with 「から」, marking the end of the range"], option_translations_en: ["Kyushu", "From... / because...", "Hokkaido", "From... to... (approximate range)"] },
  "w5-mondai2-1": { why_en: ["Follows 「黄色が」 to form 「黄色が好きで」, connecting with the te-form", "The object of 「好きだ」 takes 「が」, placed at the beginning", "Follows the noun 「下着」, meaning 'even...'", "★ position. 「下着まで」 = 'even underwear,' an extreme example. Correct"], option_translations_en: ["Like, and...", "Yellow (as subject or object)", "Even... / as far as...", "Underwear"] },
  "w5-mondai2-2": { why_en: ["Stem of 「書きかける」, placed at the beginning", "Precedes the sentence-final 「しまいました」 to form 「やめてしまいました」", "★ position. Means 'in the middle / halfway,' modifying the following 「やめて」. Correct", "Follows 「書き」 to form 「書きかけて」 = 'while writing halfway'"], option_translations_en: ["Write (ren'yōkei / continuative form)", "Stop / give up (て-form)", "In the middle of / halfway through", "Halfway through / from... to... (depending on conjugation)"] },
  "w5-mondai2-3": { why_en: ["Follows 「ここ」 to form 「ここまで」 = 'to this point/extent'", "Adverbial form, modifying the following 「調べ」", "Follows 「調べ」 to form 「調べあげる」, then takes 「ましたね」", "★ position. The ren'yōkei stem of 「調べあげる」. Correct"], option_translations_en: ["Until... / even...", "In detail", "Raise up / complete (ren'yōkei of 「上げる」)", "Investigate (ren'yōkei / continuative form)"] },
  "w5-mondai2-4": { why_en: ["Modifies 「遅れる」, meaning 'a little / slightly'", "Pairs with the sentence-initial 「もしかしたら」, preceding 「そうです」", "★ position. The sentence predicate 'be late / be delayed.' Correct", "Placed at the beginning, pairing with the sentence-final 「かもしれない」"], option_translations_en: ["A little / slightly", "Maybe / perhaps", "Be late / be delayed", "Maybe / perhaps"] },
  "w5-mondai3-0": { why_en: ["Means 'because / the reason being...' — used to add a reason afterward, but the second half is not a reason here", "Means 'moreover' — indicating addition, but the two clauses are not additive", "Means 'so / therefore' — the first clause (large body) is the cause of the second (everyone laughs). Correct", "Means 'but' — the two clauses do not form a contrastive relationship"], option_translations_en: ["Because / the reason is...", "Moreover / in addition", "So / therefore", "However / but"] },
  "w5-mondai3-1": { why_en: ["Means 'however / unexpectedly': small when named ↔ grew fat later — an unexpected turn. Correct", "Means 'as a result' — a forward-result connection, which reverses the direction", "Means 'therefore' — also a forward connection, reversed", "Means 'so' — forward connection, reversed"], option_translations_en: ["However / unexpectedly", "As a result / therefore", "Therefore / for that reason", "So"] },
  "w5-mondai3-2": { why_en: ["Means 'in other words' — used to rephrase, but this is not a rephrasing", "Means 'so' — forward causal connection, contradicting the second half", "Means 'moreover' — indicating addition, but the two clauses are not additive", "Means 'but': the name means 'small' ↔ keeps getting bigger. Correct"], option_translations_en: ["In other words", "So / therefore", "Moreover / in addition", "But (colloquial)"] },
  "w5-mondai3-3": { why_en: ["Pairs with 「ても」 for concession, but there is no 「ても」", "Means 'just like / as if,' pairing with 「クマだ」 for a simile. Correct", "Means 'of course,' which does not make sense", "Pairs with 「かもしれない」 for conjecture, but there is no 「かもしれない」"], option_translations_en: ["Even / even if", "Just like / as if", "Of course / needless to say", "Maybe / perhaps"] },
  "w5-mondai3-4": { why_en: ["Means 'in other words,' not a summary of the above", "Means 'however' — a contrast; here it's a topic shift, not a contrast", "Means 'but' — also a contrast", "Means 'by the way / that said': shifting from the neighbor's dog to talking about one's own name — a topic change. Correct"], option_translations_en: ["In other words", "However / unexpectedly", "However / but", "By the way / that said (shifting topic)"] },
  "w6-mondai1-0": { why_en: ["「ことにしている」 = a rule one sets for oneself; here it's a school regulation", "「ことになっている」 = (a group or rule) has decided thus. Correct", "「わけがない」 = impossible", "「わけにはいかない」 = cannot (out of moral/social obligation)"], option_translations_en: ["A rule one sets for oneself and follows", "It is decided/rule that... (by a group or regulation)", "Impossible", "Cannot (out of moral/social obligation)"] },
  "w6-mondai1-1": { why_en: ["「もの」 = does not form this pattern", "「こと」 = does not form this pattern", "「ところ」 = 「Vるところだった」 (almost did...). Correct", "「わけ」 = does not form this pattern"], option_translations_en: ["Thing / used for general statements or exclamations", "Matter / nominalizes the preceding clause", "About to... / just... / after trying...", "Reason / logic"] },
  "w6-mondai1-10": { why_en: ["「見えないわけがない」 = impossible not to see (reversed meaning)", "「見えるわけにはいかない」 does not work", "「見えることは見える」 = I can see, admittedly", "「見えるわけがない」 = impossible to see. Correct"], option_translations_en: ["Impossible not to see (reversed meaning)", "Cannot see (semantically unnatural)", "Can see, admittedly", "Impossible to see"] },
  "w6-mondai1-11": { why_en: ["「みる」 = dictionary form; 「ところ」 for results cannot follow the dictionary form", "「みた」 = た-form. Correct", "「みない」 = negative form; cannot follow", "「みなかった」 = negative past form; cannot follow"], option_translations_en: ["Try doing / see (dictionary form)", "Tried doing / saw (た-form)", "Do not try / do not see (negative)", "Did not try / did not see (negative past)"] },
  "w6-mondai1-12": { why_en: ["「わけではない」 = it's not that...", "「わけがない」 = impossible", "「わけだ」 = no wonder / that is to say. Correct", "「わけにはいかない」 = cannot"], option_translations_en: ["It's not that...", "Impossible", "No wonder / that is to say...", "Cannot (out of moral/social obligation)"] },
  "w6-mondai1-13": { why_en: ["「あと」 = more/remaining (with quantities). Correct", "「それと」 = also (additive)", "「もっと」 = more; cannot directly precede a number", "「その上」 = moreover"], option_translations_en: ["...remaining / ...more to go", "And / also", "More (cannot directly precede a number)", "Moreover / in addition"] },
  "w6-mondai1-14": { why_en: ["「まったく」 = completely (statement of degree)", "「決して」 = never (with strong prohibition/determination). Correct", "「めったに」 = rarely", "「少しも」 = not at all (paired with negative)"], option_translations_en: ["Completely (often paired with negative)", "Never (paired with negative, with strong determination)", "Rarely (often paired with negative)", "Not at all (paired with negative)"] },
  "w6-mondai1-2": { why_en: ["「あげないことはない」 = double negative, 'it's not that I can't help.' Correct", "「あげることはない」 = no need to help", "「あげないことじゃない」 does not work", "「あげないことにする」 = decide not to help, which doesn't connect with the following 「けれど」"], option_translations_en: ["It's not that I can't help...", "There's no need to help...", "Not a case of not being able to help (unnatural)", "Decide not to help..."] },
  "w6-mondai1-3": { why_en: ["「それと」 = addition; cannot connect clauses", "「うちに」 = 'while... / during...'", "「ところ」 = 「Vたところ」 (did... and as a result...). Correct", "「としても」 = even if"], option_translations_en: ["And / also", "While... / during...", "About to... / just... / after trying...", "Even if..."] },
  "w6-mondai1-4": { why_en: ["「勉強することにしよう」 = decide for oneself to study. Correct", "「勉強するところだった」 = almost studied, which doesn't make sense", "「勉強するわけだ」 = no wonder I study", "「勉強すればよかった」 = should have studied (regret)"], option_translations_en: ["Decide to study", "About to study / almost started studying", "No wonder I study / that is to say I'll study", "Should have studied (regret)"] },
  "w6-mondai1-5": { why_en: ["「覚めたことはあるのです」 = have experienced waking up", "「覚めないことはないのです」 = it's not that I don't wake up", "「覚めたことは覚めたのです」 = I did wake up (but...). Correct", "「覚めたことはないのです」 = have never woken up"], option_translations_en: ["Have experienced waking up", "It's not that I don't wake up", "I did wake up (conceding the first clause)", "Have never woken up"] },
  "w6-mondai1-6": { why_en: ["「まったく」 = completely (paired with negative). Correct", "「めったに」 = rarely (frequency)", "「決して」 = never (with subjective determination)", "「はじめて」 = for the first time"], option_translations_en: ["Completely (often paired with negative)", "Rarely (often paired with negative)", "Never (paired with negative, with subjective determination)", "For the first time / not until..."] },
  "w6-mondai1-7": { why_en: ["「許すわけだ」 = no wonder I forgive", "「許すわけにはいかない」 = cannot forgive (out of moral/social obligation). Correct", "「許さないわけにはいかない」 = must forgive (reversed meaning)", "「許さないわけがない」 = impossible not to forgive"], option_translations_en: ["No wonder I forgive / that is to say I forgive", "Cannot forgive", "Cannot help but forgive (reversed meaning)", "Impossible not to forgive"] },
  "w6-mondai1-8": { why_en: ["「元気」 = na-adjective stem; cannot directly precede 「うちに」", "「元気だ」 = terminal form; cannot precede", "「元気に」 = adverbial form; cannot precede", "「元気な」 = attributive form of na-adjective. Correct"], option_translations_en: ["Healthy / energetic (na-adjective stem)", "Is healthy (copula form)", "Healthily / energetically (adverbial)", "Healthy (attributive, modifying a noun)"] },
  "w6-mondai1-9": { why_en: ["「修理したら」 = if repaired (forward)", "「修理すれば」 = if repair (forward)", "「修理したとしても」 = even if repaired (concessive). Correct", "「修理するなら」 = if going to repair (forward)"], option_translations_en: ["If repaired (forward condition)", "If repair (forward condition)", "Even if repaired (concessive)", "If going to repair (forward condition)"] },
  "w6-mondai2-0": { why_en: ["Follows 「お持ち」 to form the humble expression 「お持ちしましょうか」", "Humble form of 「持つ」, placed first", "Precedes the sentence-final 「なさいますか」, being the other option", "★ position. 「それとも」 = 'or' (choosing between two), connecting two questions. Correct"], option_translations_en: ["Shall I bring/carry for you (humble)", "Hold / carry (honorific word formation)", "After / later", "Or... (choosing between two)"] },
  "w6-mondai2-1": { why_en: ["★ position. 「つぐ」 = 「継ぐ」 (inherit), connecting to the following 「ことに」. Correct", "Modifies 「店」, placed first", "Precedes the sentence-final 「なった」 to form 「ことになった」", "Object of 「つぐ」"], option_translations_en: ["Inherit (「継ぐ」)", "Father's (attributive)", "It makes one... / deciding to...", "Shop (as object)"] },
  "w6-mondai2-2": { why_en: ["Precedes 「はじめて」 to form 「Vてはじめて」", "Modifies 「日本語」", "★ position. Object of 「聞いて」. Correct", "Modifies 「自分の日本語」, placed first"], option_translations_en: ["Listen (て-form)", "One's own (attributive)", "Japanese (as object)", "Recorded"] },
  "w6-mondai2-3": { why_en: ["★ position. 「いる」 = connects with 「うちに」 to form 「いるうちに」. Correct", "Location of 「いる」", "Subject of 「いる」, placed first", "Closing, connecting to the second half"], option_translations_en: ["Be / exist", "In Japan / to Japan", "I (as subject)", "While... / during..."] },
  "w6-mondai2-4": { why_en: ["Placed first, forming 「復習したことは」", "Follows 「復習した」", "Concessive, closing and connecting to the second half", "★ position. Repeats the verb to form 「～したことはしましたが」. Correct"], option_translations_en: ["Reviewed", "...the fact that... (as topic)", "...is / as subject or contrast", "Did"] },
  "w6-mondai3-0": { why_en: ["「決して」 = never (paired with negative), matching the sentence-final 「信用しない」. Correct", "「たとえ」 requires pairing with 「ても」", "「もしかすると」 requires pairing with 「かもしれない」", "「もしも」 requires pairing with 「なら／たら」"], option_translations_en: ["Never (paired with negative)", "Even / even if", "Maybe / perhaps", "If / suppose"] },
  "w6-mondai3-1": { why_en: ["「わけにはいかない」 = cannot (out of moral/social obligation)", "「ことになっている」 = a rule set by others", "「わけがない」 = impossible", "「ことにしている」 = a rule one sets for oneself and follows. Correct"], option_translations_en: ["Cannot (out of moral/social obligation)", "It is decided/rule that... (by others)", "Impossible", "A rule one sets for oneself and follows"] },
  "w6-mondai3-2": { why_en: ["「変わる」 = 「変わるうちに」 does not work", "「変わった」 = 「うちに」 cannot follow た-form", "「変わらない」 = 「Vないうちに」 = while it hasn't changed yet. Correct", "「変わらなかった」 = た-form cannot follow"], option_translations_en: ["Change (non-past)", "Changed (past)", "Does not change", "Did not change (past)"] },
  "w6-mondai3-3": { why_en: ["「その上」 = moreover (additive)", "「それとも」 = or (choosing between two)", "「少しも」 = not at all (paired with negative)", "「あと」 = more/remaining (with quantities). Correct"], option_translations_en: ["Moreover / in addition", "Or... (choosing between two)", "Not at all (paired with negative)", "...remaining / ...more to go"] },
  "w6-mondai3-4": { why_en: ["「たとえ」 requires pairing with 「ても」", "「まったく」 = completely (paired with negative). Correct", "「もしかすると」 requires pairing with 「かもしれない」", "「もしも」 requires pairing with 「なら／たら」"], option_translations_en: ["Even / even if", "Completely (often paired with negative)", "Maybe / perhaps", "If / suppose"] },
};
...
function mergeWeeklyEnglish(weekly) {
  for (const [weekKey, sections] of Object.entries(weekly)) {
    ...
    const sectionsList = ["mondai1", "mondai2", "mondai3"];
    const items = sectionsList.flatMap((section) => sections[section] || []);
    ...
    // Merge why_en and option_translations_en from WEEKLY_DETAIL_EN
    const sectionIndex = { mondai1: 0, mondai2: 0, mondai3: 0 };
