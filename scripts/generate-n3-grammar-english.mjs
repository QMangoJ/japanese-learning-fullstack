...
const WEEKLY_DETAIL_EN = {
  ...
  "w1-mondai1-5": { why_en: ["", "", "", ""], option_translations_en: ["Like... (attributive form)", "Like... (adverbial form)", "The one that is like... (does not fit grammatically here)", "Like... (colloquial of 「みたいに」)"] },
  ...
  "w5-mondai1-0": { why_en: ["「に対して」 means 'toward' (indicating a target), and cannot express comparison", "「について」 means 'about' (indicating a topic), which does not fit here", "「代わって」 means 'instead of,' which does not make sense here", "「くらべて」 means 'compared with.' The pattern 「AにくらべてB」 = 'compared with A, B...' — correct"], option_translations_en: ["Toward... / relative to...", "About... / related to...", "Instead of... (て-form of 「代わる」)", "Compared with..."] },
  ...
  "w5-mondai1-11": { why_en: ["「たとえ～でも」 = 'even if...'. Correct", "Requires pairing with the negative 「とは限らない」; does not fit here", "「つまり」 means 'in other words,' which does not make sense", "「もしかすると」 means 'maybe,' which does not fit the tone"], option_translations_en: ["Even / even if", "Not necessarily / not always", "In other words", "Maybe / perhaps"] },
  ...
  "w5-mondai1-13": { why_en: ["Grammatically incorrect (improper nominalization)", "'Maybe it would be nice' — the tone does not match the preceding 「ば」", "Grammatically incorrect", "「～ばいいのに」 = 'if only... (expressing regret or a wish).' Correct"], option_translations_en: ["Good thing (nominalization, does not fit grammatically here)", "Maybe not bad", "Was good / originally good (does not fit grammatically here)", "If only... had / it would be nice if..."] },
  ...
  "w5-mondai1-3": { why_en: ["「まるで」 means 'just like / as if,' which does not pair with 「とは限らない」", "「必ずしも～とは限らない」 = 'not necessarily...' — a fixed collocation. Correct", "Requires pairing with 「ても」; does not fit here", "「もしかすると」 means 'maybe,' which does not pair with 「とは限らない」"], option_translations_en: ["Just like / as if", "Not necessarily / not always", "Even / even if", "Maybe / perhaps"] },
